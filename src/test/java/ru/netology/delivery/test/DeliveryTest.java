...
public class DeliveryTest {
    ...
    public void testPositiveReschedule(){
        ...
        $("[data-test-id='success-notification']").shouldHave(Condition.text("Успешно! Встреча успешно запланирована на " + firstMeetingDateSeven ),
